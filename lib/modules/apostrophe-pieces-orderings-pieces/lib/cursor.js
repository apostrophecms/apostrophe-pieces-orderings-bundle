      ...
      return {
        ...
        toArray: function(callback) {
          ...
          function body(callback) {
            ...
            // TODO: Rename this function to improve clarity around usage.
            // There are two functions here with the same name.
            function body(err) {
              if (err) {
                return callback(err);
              }
              ...
              if ((!self.get('ordering')) || (options.sort && options.sort.textScore)) {
